...
As a case study, we will map the deformation patterns of a rock glacier using DEMs that were derived from lidar and structure-from-motion topographic surveying [(Goetz et al 2019)](https://www.sciencedirect.com/science/article/pii/S0034425719302949).
